...
Runnable sample applications for **[Skymly/Observables](https://github.com/Skymly/Observables)** using the **`0.1.1-preview1`** NuGet meta-packages on [nuget.org](https://www.nuget.org/packages/Observables.Events.R3/0.1.1-preview1) (Events, RestAPI, SignalR, Mqtt, WebSocket, Grpc, Sse, and Nats).
...
`Directory.Build.props` sets `ObservablesPackageVersion` to **`0.1.1-preview1`** and `UseLocalObservables=false` by default.

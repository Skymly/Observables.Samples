...
Console sample for **`Observables.Mqtt.R3`** `0.1.0-preview6` (declarative topic interface â†?R3 `Observable` + `MqttService.For`).
...
- Source-generated proxy registration via module initializer (`RegistrationDemo` â€?no broker in CI)

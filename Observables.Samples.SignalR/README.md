...
Console sample for **`Observables.SignalR.R3`** `0.2.2` (declarative hub interface �?R3 `Observable` + `HubService.For`).

## Package reference (default)

```xml
<PackageReference Include="Observables.SignalR.R3" Version="0.2.2" />
```

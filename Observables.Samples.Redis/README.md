...
Console sample for **`Observables.Redis.R3`** `0.2.2` (declarative Redis Pub/Sub interface → R3 `Observable` + `RedisService.For`).
...
```xml
<PackageReference Include="Observables.Redis.R3" Version="0.2.2" />

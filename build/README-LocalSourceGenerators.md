...
|----------|---------|---------|
| `ObservablesPackageVersion` | `0.1.1-preview1` | NuGet version for all Observables meta-packages |
...
Published packages: [Events.R3](https://www.nuget.org/packages/Observables.Events.R3/0.1.1-preview1) and the other **16** Observables meta-packages at **`0.1.1-preview1`** on nuget.org.

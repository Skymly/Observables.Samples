...
|----------|---------|---------|
| `ObservablesPackageVersion` | `0.1.4` | NuGet version for all Observables meta-packages |
...
Published packages: [Events.R3](https://www.nuget.org/packages/Observables.Events.R3/0.1.4) and the other **16** Observables meta-packages at **`0.1.4`** on nuget.org.

...
Console sample for **`Observables.Grpc.R3`** `0.2.2` (declarative gRPC interface -> R3 `Observable` + `GrpcService.For`).

## NuGet

```xml
<PackageReference Include="Observables.Grpc.R3" Version="0.2.2" />

...
Console sample for **`Observables.RestAPI.R3`** `0.1.0-preview6` (declarative HTTP â†?`Task` and R3 `Observable`).
...
Uses [RichardSzalay.MockHttp](https://www.nuget.org/packages/RichardSzalay.MockHttp) â€?no real HTTP server.

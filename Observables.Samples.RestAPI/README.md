...
Console sample for **`Observables.RestAPI.R3`** `0.1.6-preview1` (declarative HTTP �?`Task` and R3 `Observable`).

## Package reference (default)

```xml
<PackageReference Include="Observables.RestAPI.R3" Version="0.1.6-preview1" />

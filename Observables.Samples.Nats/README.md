...
Console sample for **`Observables.Nats.R3`** `0.1.6-preview1` (declarative Core NATS subject interface �?R3 `Observable` + `NatsService.For`).

## Package reference (default)

```xml
<PackageReference Include="Observables.Nats.R3" Version="0.1.6-preview1" />
